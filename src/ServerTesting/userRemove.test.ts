...
import {requestDmCreate, requestMessageSend, requestMessageSenddm, requestDmDetails, requestUserProfileV3, requestuserSetemailV2, requestuserProfileSethandleV2, requestUsersAllV2 } from '../wrappers'
...
beforeEach(() => {
  ...
  mIdChannel2 = requestMessageSend(registered2.token, channelId1, 'love is love').body.messageId;
  mIdDm = requestMessageSenddm(registered1.token, dmId, 'Hi my dogs').body.messageId;
  mIdDm2 = requestMessageSenddm(registered2.token, dmId, 'I miss you').body.messageId;
});
