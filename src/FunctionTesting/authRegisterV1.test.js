...
describe("Incorrect Registration", () => {
    test.each([
        { testName: 'incorrect email', email: 'foo.bar', password: 'hello123', nameFirst: 'Daniel', nameLast: 'Murphy' },
        ...
        expect(authRegisterV1(email, password, nameFirst, nameLast)).toBe({ error: 'error' });
    });
});
